...
public class CastingEx {
    public static void main(String[] args) {
        ...
        // int => char
        // int 타입은 char 타입으로 자동변환 되지 않고, (char)강제 캐스팅해야 한다. 0~65535 사이의 값만 원래 값을 유지
        ...
        double result2 = 1.2f + 2.4f; // 컴파일 byte result2 = 4.6f; 되며 자동변환으로 double 타입으로 변환된다
        ...
        System.out.println(v1); // String str1 = "3" + "7"; str1 = "37"
